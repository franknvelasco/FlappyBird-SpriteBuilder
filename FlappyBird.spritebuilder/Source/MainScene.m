...
@implementation MainScene {
    //These declare parallax ratios for clouds and bushes
    ...
    //Used to hold in the clouds so that they scroll
    CCNode *_cloud1;
    CCNode *_cloud2;
    NSArray *_clouds;
    
    //Used to hold in the bushes so that they scroll
    CCNode *_bush1;
    CCNode *_bush2;
    NSArray *_bushes;
...
- (void)didLoadFromCCB {
    ...
    //Make parallaxBackground a child of parallaxContainer (already created through SpriteBuilder)
